...
#include "random-access/ue-lte-random-access.h"
#include "random-access/ue-enhanced-lte-random-access.h"
...
UeMacEntity::UeMacEntity (NetworkNode* d)
{
  ...
  m_uerandomaccess = new UeLteRandomAccess(this);
...
void UeMacEntity::SetRandomAccessType(UeRandomAccess::RandomAccessType type)
{
  ...
  switch (type)
    {
    case UeRandomAccess::RA_TYPE_LTE:
      m_uerandomaccess=new UeLteRandomAccess(this);
      break;

    case UeRandomAccess::RA_TYPE_ENHANCED_LTE:
      m_uerandomaccess=new UeEnhancedLteRandomAccess(this);
      break;
