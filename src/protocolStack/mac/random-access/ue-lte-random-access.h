...
#ifndef UE_LTE_RANDOM_ACCESS_H_
#define UE_LTE_RANDOM_ACCESS_H_
...
class UeLteRandomAccess : public UeRandomAccess
{
public:

  UeLteRandomAccess();
  UeLteRandomAccess(MacEntity* mac);
  virtual ~UeLteRandomAccess();
