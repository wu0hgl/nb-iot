...
class EnbNbIoTRandomAccess : public EnbRandomAccess
{
...
public:
  ...
  EnbNbIoTRandomAccess();
  EnbNbIoTRandomAccess(MacEntity* mac);
  virtual ~EnbNbIoTRandomAccess();

  void SetEnbNbIoTRandomAccess();
  void GetEnbNbIoTRandomAccess();
...
private:
  ...
  AllocationMap m_tonesReservedForRach;
