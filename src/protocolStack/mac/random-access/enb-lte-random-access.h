...
#ifndef ENB_LTE_RANDOM_ACCESS_H_
#define ENB_LTE_RANDOM_ACCESS_H_
...
class EnbLteRandomAccess : public EnbRandomAccess
{
...
public:
  ...
  EnbLteRandomAccess();
  EnbLteRandomAccess(MacEntity* mac);
  virtual ~EnbLteRandomAccess();

  void SetEnbLteRandomAccess();
  void GetEnbLteRandomAccess();
...
#endif /* ENB_LTE_RANDOM_ACCESS_H_ */
