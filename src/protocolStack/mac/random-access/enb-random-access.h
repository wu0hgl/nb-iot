...
#ifndef ENB_RANDOM_ACCESS_H_
#define ENB_RANDOM_ACCESS_H_
#include <vector>
#include <map>
...
public:
  ...
  {
    RA_TYPE_LTE,
    RA_TYPE_ENHANCED_LTE,
    RA_TYPE_NB_IOT
  };

  EnbRandomAccess();
  EnbRandomAccess(MacEntity* mac);
  virtual ~EnbRandomAccess();

  void SetEnbRandomAccessType(RandomAccessType type);
  RandomAccessType GetEnbRandomAccessType();
