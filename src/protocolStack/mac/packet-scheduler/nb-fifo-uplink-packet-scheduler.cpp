...
nbFifoUplinkPacketScheduler::nbFifoUplinkPacketScheduler(EnbMacEntity* mac)
{
  SetMacEntity (mac);
...
nbFifoUplinkPacketScheduler::RUsAllocation ()
{
  ...
  EnbNbIoTRandomAccess* enbRam = (EnbNbIoTRandomAccess*) GetMacEntity()->GetRandomAccessManager() ;
...
DEBUG_LOG_START_1(LTE_SIM_SCHEDULER_DEBUG_FIFO)
