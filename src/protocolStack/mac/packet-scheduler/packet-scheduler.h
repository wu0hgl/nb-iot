...
public:
  ...
  void SetMacEntity (EnbMacEntity* mac);
  EnbMacEntity* GetMacEntity (void);
  ...
  struct FlowToSchedule
  {
    ...
    UserEquipment* m_ue;
    ENodeB::UserEquipmentRecord* m_ueRecord;
    ...
    void SetUeRecord(ENodeB::UserEquipmentRecord* record);
    ENodeB::UserEquipmentRecord* GetUeRecord();
