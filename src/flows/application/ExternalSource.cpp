...
{
  SetApplicationType (Application::APPLICATION_TYPE_EXTERNAL_SOURCE);

}

void
ExternalSource::DoStart (void)
{
}

void
ExternalSource::DoStop (void)
{
}

void
ExternalSource::Send (Packet *p)
{
  Trace (p);
  enqueue (p);
}
...
double
ExternalSource::GetInterval (void) const
{
  return m_interval;
}
