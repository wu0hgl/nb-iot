    ...
    ENodeB* target)
{
  ...
  MulticastDestinationLtePhy *phy = new MulticastDestinationLtePhy ();
  phy->SetDevice(this);
...
void
MulticastDestination::AddSource(ENodeB *n)
{
  m_sources.push_back(n);
}

void
MulticastDestination::DeleteSource(ENodeB *n)
{
...
void
MulticastDestination::SetSources(vector<ENodeB*> sources)
{
  m_sources = sources;
}
