...
static void Simple ()
{
  ...
  int EnbTxAntennas = 1;
  int EnbRxAntennas = 1;
  ENodeB* enb = networkManager->CreateEnodeb (idEnb, cell, posX, posY, EnbTxAntennas, EnbRxAntennas, dlCh, ulCh, spectrum);
  ...
  int UeTxAntennas = 1;
  int UeRxAntennas = 1;
  UserEquipment* ue = networkManager->CreateUserEquipment (idUe, posX_ue, posY_ue, speed, speeDirection, UeTxAntennas, UeRxAntennas, cell, enb);
