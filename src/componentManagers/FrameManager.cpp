...
{
DEBUG_LOG_START_1(LTE_SIM_FRAME_MANAGER_DEBUG)
  cout << " LTE Simulation starts now! "<< endl;
DEBUG_LOG_END
...
{
DEBUG_LOG_START_2(LTE_SIM_FRAME_MANAGER_DEBUG,LTE_SIM_START_SUBFRAME_DEBUG)
...
DEBUG_LOG_START_1(LTE_SIM_PLOT_USER_POSITION)
...
{
  vector<ENodeB*> *records = GetNetworkManager ()->GetENodeBContainer ();
  for (auto record : *records)
    {

DEBUG_LOG_START_1(LTE_SIM_FRAME_MANAGER_DEBUG)
      cout << " FRAME_MANAGER_DEBUG: RBs allocation for eNB " <<
...
DEBUG_LOG_END
  ...
  vector<HeNodeB*> *records_2 = GetNetworkManager ()->GetHomeENodeBContainer();
