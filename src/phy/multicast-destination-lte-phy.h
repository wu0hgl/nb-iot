...
#ifndef MULTICAST_DESTINATION_LTE_PHY_H_
#define MULTICAST_DESTINATION_LTE_PHY_H_

#include "ue-lte-phy.h"

class MulticastDestination;

class MulticastDestinationLtePhy :public UeLtePhy
{
public:
  MulticastDestinationLtePhy ();
  void CreateCqiFeedbacks ();
  MulticastDestination* GetDevice(void);
};

#endif /* MULTICAST_DESTINATION_LTE_PHY_H_ */
